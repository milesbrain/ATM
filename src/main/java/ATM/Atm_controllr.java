...
public class Atm_controllr implements Initializable {
    ...
    public void saveToDatabase() throws SQLException {
        Alert alert;
        String AccountNo =customerIdTextField.getText();
        ...
        try {
            ...
            String url = "jdbc:mysql://localhost:3306/newaccount";
            String user = "root";
            String password = "Godbless101";
            ...
            try (PreparedStatement preparedStatement = connection.prepareStatement(insertQuery)) {
                ...
                if (rowsAffected > 0) {
                    ...
                    try {
                        ...
                        stage = (Stage) customerIdTextField.getScene().getWindow();
        ...
        if (customerIdTextField != null) {
            customerIdTextField.textProperty().addListener((observable, oldValue, newValue) -> {
                if (!newValue.matches("\\d{0,10}?")) {
                    customerIdTextField.setText(oldValue);
